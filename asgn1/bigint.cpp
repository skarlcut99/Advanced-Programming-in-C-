...
bigint bigint::operator* (const bigint& that) const 
{
   bigint result;
   result.uvalue = uvalue * that.uvalue;
   if((this->is_negative == true && that.is_negative == true) || (this->is_negative == false && that.is_negative == false))
      result.is_negative = false;
   else
...
bigint bigint::operator/ (const bigint& that) const 
{
   ...
   if (result == ZERO)
      result.is_negative = false;
   else if ((this->is_negative == true && that.is_negative == true) || (this->is_negative == false && that.is_negative == false))
      result.is_negative = false;
   else
      result.is_negative = true;
   return result;
...
bigint bigint::operator% (const bigint& that) const 
{
   ...
   if(result == ZERO)
      ...
      result.is_negative = false;
   else if(that.is_negative == true && this->is_negative == false)
      result.is_negative = false;
   else
      result.is_negative = true;
   return result;
